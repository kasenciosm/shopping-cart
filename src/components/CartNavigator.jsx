...
export default function CartNavigator({ count, className }) {
    ...
    return (
        <aside
            ...
            <aside className={(showCart ? '-right-0' : 'hidden') + ' fixed top-20 w-96 h-full space-x-1 place-items-center text-left bg-gray-500 bg-opacity-100  text-white space-y-5 p-8 scroll-mt-24'}>
